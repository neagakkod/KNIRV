...
<body>
    ...
    <table width=400>
        <tr>
            <td>Refund Status:</td>
            <td><?php echo $response->refundInfoList->refundInfo->refundStatus ?></td>
        </tr>
        <tr>
            <td>Receiver:</td>
            <td><?php echo $response->refundInfoList->refundInfo->receiver->email ?></td>
        </tr>
        <tr>
            <td>Net Refund Amount:</td>
            <td><?php echo $response->refundInfoList->refundInfo->refundGrossAmount ?></td>
        </tr>
